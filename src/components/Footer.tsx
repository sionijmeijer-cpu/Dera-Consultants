  ...
  return (
    <footer className="bg-gradient-to-b from-[#0f3460] to-[#0a1f35] text-gray-300">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm">
              ...
              <li>
                <a href="/services" className="hover:text-[#1B7A4E] transition-colors duration-200">
                  Services
                </a>
              </li>
          ...
          <div>
            ...
            <div className="flex gap-4 mt-4">
              ...
              <a
                href="https://www.facebook.com/profile.php?id=100095517183538"
                target="_blank"
              ...
              <a
                href="https://www.instagram.com/deraconsultants/"
                target="_blank"
                rel="noopener noreferrer"
                className="hover:text-[#1B7A4E] transition-colors duration-200"
              >
              ...
              <a
                href="https://www.linkedin.com/company/dera-consultants"
                target="_blank"
                rel="noopener noreferrer"
                className="hover:text-[#1B7A4E] transition-colors duration-200"
              >
        ...
        {/* Trustpilot Badge */}
        <div className="border-t border-[#1a5276] mt-10 pt-8 flex justify-center">
          <TrustpilotFooter />
        </div>
        ...
        <div className="mt-6 text-sm text-center">
          <p>
            &copy; 2026 Dera Consultants. All rights reserved. |{' '}
            <span className="text-[#1B7A4E]">
              Excellence in Global Immigration Solutions
            </span>
          </p>
        </div>
