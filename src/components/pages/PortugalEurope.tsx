...
const mistakes = [
  ...
  },
  {
    ...
    body: 'Consulate appointments in the US, UK, and South Africa can be booked out 3 to 6 months in advance. Add document apostilles, translations, and SEF/AIMA processing and you\'re often looking at 12 to 18 months from start to approval.',
  },
  {
    icon: '💸',
