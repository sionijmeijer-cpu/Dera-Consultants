      ...
      <section className="py-16">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
            ...
            <div className="space-y-8">
              <div>
                ...
                <p className="text-gray-600 mb-8">
                  Have questions about our immigration services? Our team of experts is here to help. Reach out to us through any of the channels below or fill out the contact form.
                </p>
              </div>
              ...
              <div className="space-y-6">
                <div className="flex items-start gap-4 p-4 bg-gray-50 rounded-lg hover:shadow-md transition-all duration-200 border-l-4 border-[#d4af37]">
                  ...
                  <div>
                    ...
                    <a href="mailto:info@deraconsultants.com" className="text-[#0f3460] hover:underline font-medium">
                ...
                <div className="flex items-start gap-4 p-4 bg-gray-50 rounded-lg hover:shadow-md transition-all duration-200 border-l-4 border-[#0f3460]">
                  ...
                  <div>
                    ...
                    <a href="tel:+1234567890" className="text-[#0f3460] hover:underline font-medium">
                      +1 (234) 567-890
                    </a>
                ...
                <div className="flex items-start gap-4 p-4 bg-gray-50 rounded-lg hover:shadow-md transition-all duration-200 border-l-4 border-[#d4af37]">
                  ...
                  <div>
                    ...
                    <a href="https://wa.me/1234567890" target="_blank" rel="noopener noreferrer" className="text-[#0f3460] hover:underline font-medium">
                      +1 (234) 567-890
                    </a>
            ...
            {/* Contact Form */}
            <div className="bg-gradient-to-br from-[#f5f5f5] to-[#e8dcc4] p-8 rounded-2xl shadow-lg">
              ...
              {submitted ? (
                ...
                <form onSubmit={handleSubmit} className="space-y-4">
                  ...
                  <button
                    type="submit"
                    className="w-full bg-gradient-to-r from-[#0f3460] to-[#1a5276] text-white px-6 py-3 rounded-lg font-semibold hover:from-[#d4af37] hover:to-[#c9a02e] hover:text-[#0f3460] transition-all duration-300 shadow-md hover:shadow-lg flex items-center justify-center gap-2"
                  >
        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="space-y-4">
            ...
            <div className="bg-white p-6 rounded-lg shadow-sm border-l-4 border-[#0f3460]">
              ...
              <p className="text-gray-600">
                Most applications can be processed without travel, though some programs may require an interview or final approval visit. We'll guide you through the specific requirements for your chosen program.
              </p>
            </div>
