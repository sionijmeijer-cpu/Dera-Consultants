...
export default function CompanyPage({ onScheduleCall }: CompanyPageProps) {
  ...
  return (
    <div className="bg-white">
      ...
      {/* Guides Section */}
      <GuideSection onScheduleCall={handleScheduleCall} />

      {/* CTA Section */}
      <section className="py-16 md:py-24 px-4 sm:px-6 lg:px-8 bg-gradient-to-r from-[#0f3460] to-[#1B7A4E]">
        <div className="max-w-4xl mx-auto text-center">
          <h2 className="text-3xl md:text-4xl font-bold text-white mb-6">Ready to Explore Your Options?</h2>
          <p className="text-lg text-white/90 mb-8">Schedule a consultation with our team to discuss your citizenship and residency goals.</p>
          <button
            onClick={handleScheduleCall}
            className="bg-white text-[#1B7A4E] px-8 py-4 rounded-lg font-bold hover:bg-gray-100 transition-all duration-300 inline-flex items-center gap-2"
          >
